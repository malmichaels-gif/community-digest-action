...
export function renderDigest(data: DigestData, config: Config): string {
  ...
  if (config.footerStarLink) {
    ...
    lines.push('');
    lines.push(
      `*Generated by [community-digest-action](https://github.com/your-org/community-digest-action) — ` +
        `[give it a star](https://github.com/your-org/community-digest-action) if you find it useful!*`
    );
  }
